...
#%>%
#   select(!'Quinta..Instalaciones...Ninguna',
#          'Producción.no.horticola..Cereales',
#          'Producción.no.horticola..Forrajes',
#          'Producción.no.horticola..Oleaginosas',
#          'Agua.para.riego..Fuente...Agua.de.red',
#          'Agua.para.riego..Fuente...Otra',
#          'Herramientas..sembradora...Contrata',
#          'Herramienta..Pulverizadora...Propiedad.compartida',
#          'Herramienta..Pulverizadora...Contrata',
#          )
