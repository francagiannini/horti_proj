...
#esta tomando la base nobinaria
...
data_sel_cat <- base_quintas %>%
  mutate(isElite = factor(Intalaciones_nro)) %>%
  mutate(isElite = factor(Beneficios_publicos)) %>%
...
write_excel_csv2(resanova, "resanova_prod.xlsx", delim=";")
...
write_excel_csv2(resanova, "resanova_hoja.xlsx", delim=";")
...
anov <- function(i){
  ...
  cbind(colnames(data_sel_cat)[i], a, a<0.1)
...
write_excel_csv2(resanova, "resanova_prod_tallo_bulbo.xlsx", delim=";")
resanova %>% filter(p< 0.1)
...
write_excel_csv2(resanova, "resanova_prod_fruto.xlsx", delim=";")
resanova %>% filter(p< 0.1)
...
write_excel_csv2(resanova, "resanova_prod_tuberculo_raiz.xlsx", delim=";")
resanova %>% filter(p< 0.1)
...
write_excel_csv2(resanova, "resanova_prod_inflo_col.xlsx", delim = ";")
resanova %>% filter(p< 0.1)
...
data_sel_cat <- base_quintas %>%
  mutate(isElite = factor(Intalaciones_nro)) %>%
  mutate(isElite = factor(Beneficios_publicos)) %>%
  select_if(is.character) data_sel_cat$sup_hoja <- base_quintas$sup_hoja
...
write_excel_csv2(resanova, "resanova_sup_hoja.xlsx", delim=";")
...
write_excel_csv2(resanova, "resanova_sup_fruto.xlsx", delim=";")
resanova %>% filter(p< 0.1)
...
write_excel_csv2(resanova, "resanova_sup_inflo_col.xlsx", delim = ";")
resanova %>% filter(p< 0.1)
...
write_excel_csv2(resanova, "resanova_sup_tuberculo_raiz.xlsx", delim=";")
resanova %>% filter(p< 0.1)
...
write_excel_csv2(resanova, "resanova_sup_tallo_bulbo.xlsx", delim=";")
resanova %>% filter(p< 0.1)
...
write_excel_csv2(resanova, "resanova_rec_hoja.xlsx", delim=";")
...
write_excel_csv2(resanova, "resanova_rec_fruto.xlsx", delim=";")
resanova %>% filter(p< 0.1)
...
write_excel_csv2(resanova, "resanova_rec_inflo_col.xlsx", delim = ";")
resanova %>% filter(p< 0.1)
...
write_excel_csv2(resanova, "resanova_rec_tuberculo_raiz.xlsx", delim=";")
resanova %>% filter(p< 0.1)
...
write_excel_csv2(resanova, "resanova_rec_tallo_bulbo.xlsx", delim=";")
resanova %>% filter(p< 0.1)
...
write_excel_csv2(resanova, "resanova_no_rows.xlsx", delim=";")
resanova %>% filter(p< 0.1)
